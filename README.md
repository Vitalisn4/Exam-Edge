...
|------------|-------------|
| **Board-accurate marking** | Partial-credit marking (M1/A1/B1) aligned to national examination conventions |
...
1. **Examiner Marking** — M1/A1/B1 partial-credit awards (Claude Haiku)
