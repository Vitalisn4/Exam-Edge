...
|-----------|----------------|
| **Welcome first** | Landing page explains *why* before *how* |
...
**Tagline for onboarding:** *"Learn deeply. Prepare confidently. Any exam. Any country."*
...
*Update when onboarding UI, Graduate Success module, or privacy copy changes.*
