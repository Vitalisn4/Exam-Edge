...
|-------|-------|
| **Feature ID** | F-40 |
| **Feature name** | UVE L3-L4 Probes |
| **Release** | V1.1 |
| **Branch** | `feature/f-40-uve-l3-l4` |
| **Prerequisites** | Unit 13 merged to main. |

## Purpose and business objectives

Conceptual explanation (L3) and transfer challenge (L4) probes

## Problem statement

Post-MVP expansion requires **UVE L3-L4 Probes** to scale ExamEdge beyond the Cameroon MVP pilot per `roadmap.md`.

## User value

UVE L3-L4 Probes unlocks the roadmap milestone for **V1.1**, extending access, security, or platform capabilities for students, teachers, and institutional partners.

## User stories

- As a platform stakeholder, I need uve l3-l4 probes so ExamEdge can expand per roadmap.md without breaking MVP invariants.
- As a developer, I implement uve l3-l4 probes on a dedicated branch with full test coverage and documentation updates.
- As a student or teacher (where applicable), I benefit from uve l3-l4 probes without regression to core marking, hints, or offline study flows.

## Acceptance criteria

- [ ] L3/L4 async after marking; MVS delta updated; zero answer leakage

## Prerequisites and dependencies

Unit 13 merged to main.
...
- [ ] `AGENTS.md` § UVE · `ai-cost-and-exam-system.md`
...
Implement UVE L3-L4 Probes per roadmap.md and architecture.md.
...
Sonnet for L3-L4 generation and evaluation; extend `uve.ts`
...
4. Create branch `feature/f-40-uve-l3-l4`.
