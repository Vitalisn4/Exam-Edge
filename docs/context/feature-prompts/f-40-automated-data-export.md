...
| **Release** | V1.1 |
| **Branch** | `feature/f-40-export` |
| **Prerequisites** | Unit 23 profile privacy complete. |
...
Post-MVP expansion requires Automated Data Export to scale ExamEdge beyond the Cameroon pilot.

## User value

Automated Data Export unlocks the roadmap milestone described in roadmap.md for V1.1.

## User stories

- As a platform stakeholder, I need automated data export so that ExamEdge can expand per roadmap.md.
- As a developer, I implement automated data export without breaking MVP invariants.

## Acceptance criteria

- [ ] roadmap.md acceptance criteria for F-40 met

## Prerequisites

Complete these units/features before starting F-40:
