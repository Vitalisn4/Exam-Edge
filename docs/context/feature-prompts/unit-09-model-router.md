...
|-------|-------|
| **Feature ID** | Unit 09 |
| **Feature name** | Model Router + Chain Infrastructure |
| **Release** | V1.0 MVP |
| **Branch** | `feature/unit-09-model-router` |
| **Prerequisites** | Units 01 and 08 merged to main. |
...
This unit is required to deliver **Model Router + Chain Infrastructure** as defined in `build-plan.md` Unit 09. Without it, the MVP pilot cannot proceed to the next build phase.
...
Units 01 and 08 merged to main.
...
- [ ] docs/context/ai-workflow-rules.md
...
- [ ] Router returns Haiku for marking, Sonnet for hint_3
- [ ] Sanitize strips known injection patterns
...
4. Create branch `feature/unit-09-model-router`.
