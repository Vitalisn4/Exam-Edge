...
|-------|-------|
| **Feature ID** | Unit 24 |
| **Feature name** | Question Pool + Parameter Instantiation |
| **Release** | V1.0 MVP |
| **Branch** | `feature/unit-24-question-pool` |
| **Prerequisites** | Units 05, 12, and 17 merged to main. |
...
This unit is required to deliver **Question Pool + Parameter Instantiation** as defined in `build-plan.md` Unit 24. Without it, the MVP pilot cannot proceed to the next build phase.
...
Units 05, 12, and 17 merged to main.
...
- [ ] instantiateParams determinism
- [ ] renderTemplate with params

## Integration testing requirements

- [ ] Pool selection excludes recent templates
- [ ] validated=false never returned
...
4. Create branch `feature/unit-24-question-pool`.
