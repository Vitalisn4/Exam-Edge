...
| **Release** | V1.1 |
| **Branch** | `feature/f-37-french-i18n` |
| **Prerequisites** | MVP UI complete. |
...
Post-MVP expansion requires French UI (i18n Framework) to scale ExamEdge beyond the Cameroon pilot.

## User value

French UI (i18n Framework) unlocks the roadmap milestone described in roadmap.md for V1.1.

## User stories

- As a platform stakeholder, I need french ui (i18n framework) so that ExamEdge can expand per roadmap.md.
- As a developer, I implement french ui (i18n framework) without breaking MVP invariants.

## Acceptance criteria

- [ ] roadmap.md acceptance criteria for F-37 met

## Prerequisites

Complete these units/features before starting F-37:
