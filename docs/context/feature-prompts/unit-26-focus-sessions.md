...
|-------|-------|
| **Feature ID** | Unit 26 |
| **Feature name** | Focus Session Architecture |
| **Release** | V1.0 MVP |
| **Branch** | `feature/unit-26-focus-sessions` |
| **Prerequisites** | Unit 25 merged to main. |
...
This unit is required to deliver **Focus Session Architecture** as defined in `build-plan.md` Unit 26. Without it, the MVP pilot cannot proceed to the next build phase.
...
4. Create branch `feature/unit-26-focus-sessions`.
