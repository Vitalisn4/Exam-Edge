...
This unit is required to deliver **Examiner Marking Chain** as defined in `build-plan.md` Unit 10. Without it, the MVP pilot cannot proceed to the next build phase.
...
4. Create branch `feature/unit-10-marking-chain`.
