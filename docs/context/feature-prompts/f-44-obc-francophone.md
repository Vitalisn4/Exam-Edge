...
|-------|-------|
| **Feature ID** | F-44 |
| **Feature name** | OBC / Francophone Cameroon |
| **Release** | V2.0 |
| **Branch** | `feature/f-44-obc-francophone` |
| **Prerequisites** | F-38 French i18n complete. |

## Purpose and business objectives

French curriculum + BEPC marking conventions

## Problem statement

Post-MVP expansion requires **OBC / Francophone Cameroon** to scale ExamEdge beyond the Cameroon MVP pilot per `roadmap.md`.

## User value

OBC / Francophone Cameroon unlocks the roadmap milestone for **V2.0**, extending access, security, or platform capabilities for students, teachers, and institutional partners.

## User stories

- As a platform stakeholder, I need obc / francophone cameroon so ExamEdge can expand per roadmap.md without breaking MVP invariants.
- As a developer, I implement obc / francophone cameroon on a dedicated branch with full test coverage and documentation updates.
- As a student or teacher (where applicable), I benefit from obc / francophone cameroon without regression to core marking, hints, or offline study flows.

## Acceptance criteria

- [ ] roadmap.md acceptance criteria for F-44 met
- [ ] No regression to MVP Units 01–31 behaviour
- [ ] Security and RBAC requirements satisfied

## Prerequisites and dependencies

F-38 French i18n complete.
...
- [ ] `roadmap.md` · F-38 i18n · `content-governance.md`
...
Implement OBC / Francophone Cameroon per roadmap.md and architecture.md.
...
4. Create branch `feature/f-44-obc-francophone`.
