...
This unit is required to deliver **Pilot Hardening + Demo Script** as defined in `build-plan.md` Unit 31. Without it, the MVP pilot cannot proceed to the next build phase.
...
All Units 01–30 merged to main.
...
4. Create branch `feature/unit-31-pilot-hardening`.
