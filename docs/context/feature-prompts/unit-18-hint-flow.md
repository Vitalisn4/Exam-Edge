...
This unit is required to deliver **Hint Flow** as defined in `build-plan.md` Unit 18. Without it, the MVP pilot cannot proceed to the next build phase.
...
Units 11 and 17 merged to main.
...
4. Create branch `feature/unit-18-hint-flow`.
