...
| **Release** | V2.0 |
| **Branch** | `feature/f-43-obc-francophone` |
| **Prerequisites** | F-37 French i18n and F-41 board pattern complete. |
...
Post-MVP expansion requires OBC / Francophone Cameroon to scale ExamEdge beyond the Cameroon pilot.

## User value

OBC / Francophone Cameroon unlocks the roadmap milestone described in roadmap.md for V2.0.

## User stories

- As a platform stakeholder, I need obc / francophone cameroon so that ExamEdge can expand per roadmap.md.
- As a developer, I implement obc / francophone cameroon without breaking MVP invariants.
...
Complete these units/features before starting F-43:
