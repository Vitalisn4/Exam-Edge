...
| **Release** | V2.0 / V3.0 |
| **Branch** | `feature/f-50-routing` |
| **Prerequisites** | Unit 09 router complete; marking benchmarks established. |
...
Post-MVP expansion requires Local Model Routing to scale ExamEdge beyond the Cameroon pilot.

## User value

Local Model Routing unlocks the roadmap milestone described in roadmap.md for V2.0 / V3.0.

## User stories

- As a platform stakeholder, I need local model routing so that ExamEdge can expand per roadmap.md.
- As a developer, I implement local model routing without breaking MVP invariants.

## Acceptance criteria

- [ ] roadmap.md acceptance criteria for F-50 met

## Prerequisites

Complete these units/features before starting F-50:
...
Router change only — chain interfaces unchanged.
