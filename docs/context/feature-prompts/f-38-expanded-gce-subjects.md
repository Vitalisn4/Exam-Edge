# F-38: Expanded GCE Subject Coverage
...
| **Release** | V1.1 |
| **Branch** | `feature/f-38-subjects` |
| **Prerequisites** | Units 05 and 29 complete. |
...
Post-MVP expansion requires Expanded GCE Subject Coverage to scale ExamEdge beyond the Cameroon pilot.

## User value

Expanded GCE Subject Coverage unlocks the roadmap milestone described in roadmap.md for V1.1.

## User stories

- As a platform stakeholder, I need expanded gce subject coverage so that ExamEdge can expand per roadmap.md.
- As a developer, I implement expanded gce subject coverage without breaking MVP invariants.

## Acceptance criteria

- [ ] roadmap.md acceptance criteria for F-38 met

## Prerequisites

Complete these units/features before starting F-38:
