# F-48: Advanced Cognitive Fingerprint
...
|-------|-------|
| **Feature ID** | F-48 |
| **Feature name** | Advanced Cognitive Fingerprint |
| **Release** | V2.0 |
| **Branch** | `feature/f-48-cognitive-fingerprint` |
| **Prerequisites** | Units 13 and 30 merged to main. |

## Purpose and business objectives

Error pattern clustering; learning style adaptation post-session

## Problem statement

Post-MVP expansion requires **Advanced Cognitive Fingerprint** to scale ExamEdge beyond the Cameroon MVP pilot per `roadmap.md`.

## User value

Advanced Cognitive Fingerprint unlocks the roadmap milestone for **V2.0**, extending access, security, or platform capabilities for students, teachers, and institutional partners.

## User stories

- As a platform stakeholder, I need advanced cognitive fingerprint so ExamEdge can expand per roadmap.md without breaking MVP invariants.
- As a developer, I implement advanced cognitive fingerprint on a dedicated branch with full test coverage and documentation updates.
- As a student or teacher (where applicable), I benefit from advanced cognitive fingerprint without regression to core marking, hints, or offline study flows.

## Acceptance criteria

- [ ] Cron updates `users.cognitive_fp`; hints adapt to error patterns

## Prerequisites and dependencies

Units 13 and 30 merged to main.
...
- [ ] `AGENTS.md` § Memory · `platform-how-it-works.md`
...
Implement Advanced Cognitive Fingerprint per roadmap.md and architecture.md.
...
Existing `cognitive_fp` JSONB — no new tables required
...
4. Create branch `feature/f-48-cognitive-fingerprint`.
