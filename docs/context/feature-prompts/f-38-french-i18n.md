...
|-------|-------|
| **Feature ID** | F-38 |
| **Feature name** | French UI / i18n Framework |
| **Release** | V1.1 |
| **Branch** | `feature/f-38-french-i18n` |
| **Prerequisites** | MVP student UI complete. |

## Purpose and business objectives

next-intl or equivalent; French UI for Francophone expansion prep

## Problem statement

Post-MVP expansion requires **French UI / i18n Framework** to scale ExamEdge beyond the Cameroon MVP pilot per `roadmap.md`.

## User value

French UI / i18n Framework unlocks the roadmap milestone for **V1.1**, extending access, security, or platform capabilities for students, teachers, and institutional partners.

## User stories

- As a platform stakeholder, I need french ui / i18n framework so ExamEdge can expand per roadmap.md without breaking MVP invariants.
- As a developer, I implement french ui / i18n framework on a dedicated branch with full test coverage and documentation updates.
- As a student or teacher (where applicable), I benefit from french ui / i18n framework without regression to core marking, hints, or offline study flows.

## Acceptance criteria

- [ ] Language toggle; curriculum chain accepts `language: 'fr'`

## Prerequisites and dependencies

MVP student UI complete.
...
- [ ] `platform-ecosystem-ops.md` · `roadmap.md`
...
Implement French UI / i18n Framework per roadmap.md and architecture.md.
...
4. Create branch `feature/f-38-french-i18n`.
