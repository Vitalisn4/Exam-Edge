...
| **Release** | V2.0 |
| **Branch** | `feature/f-49-payment-subscription` |
...
Post-MVP expansion requires Payment / Subscription to scale ExamEdge beyond the Cameroon pilot.

## User value

Payment / Subscription unlocks the roadmap milestone described in roadmap.md for V2.0.

## User stories

- As a platform stakeholder, I need payment / subscription so that ExamEdge can expand per roadmap.md.
- As a developer, I implement payment / subscription without breaking MVP invariants.

## Acceptance criteria

- [ ] roadmap.md acceptance criteria for F-49 met

## Prerequisites

Complete these units/features before starting F-49:
