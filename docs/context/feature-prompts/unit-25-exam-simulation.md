...
This unit is required to deliver **Exam Simulation Mode** as defined in `build-plan.md` Unit 25. Without it, the MVP pilot cannot proceed to the next build phase.
...
Units 17 and 24 merged to main.
...
4. Create branch `feature/unit-25-exam-simulation`.
