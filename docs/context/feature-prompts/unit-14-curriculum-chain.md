...
|-------|-------|
| **Feature ID** | Unit 14 |
| **Feature name** | Curriculum Intelligence Chain |
| **Release** | V1.0 MVP |
| **Branch** | `feature/unit-14-curriculum-chain` |
| **Prerequisites** | Units 05 and 09 merged to main. |
...
This unit is required to deliver **Curriculum Intelligence Chain** as defined in `build-plan.md` Unit 14. Without it, the MVP pilot cannot proceed to the next build phase.
...
Units 05 and 09 merged to main.
...
Implement AI chain per AGENTS.md for Unit 14. Haiku/Sonnet assignment via router.ts. No client-side LLM calls.
...
- [ ] Cache hit returns without LLM mock call
- [ ] No syllabus → abort with safe error
...
4. Create branch `feature/unit-14-curriculum-chain`.
