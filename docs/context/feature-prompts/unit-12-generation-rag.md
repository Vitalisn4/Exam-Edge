...
|-------|-------|
| **Feature ID** | Unit 12 |
| **Feature name** | Question Generation Chain + RAG |
| **Release** | V1.0 MVP |
| **Branch** | `feature/unit-12-generation-rag` |
...
This unit is required to deliver **Question Generation Chain + RAG** as defined in `build-plan.md` Unit 12. Without it, the MVP pilot cannot proceed to the next build phase.
...
- [ ] RAG abort when k < 5
- [ ] Zod validation on generation output

## Integration testing requirements

- [ ] pgvector query with seeded embeddings
...
4. Create branch `feature/unit-12-generation-rag`.
