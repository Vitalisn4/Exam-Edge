...
This unit is required to deliver **Landing Page UI** as defined in `build-plan.md` Unit 03. Without it, the MVP pilot cannot proceed to the next build phase.
...
4. Create branch `feature/unit-03-landing-page`.
