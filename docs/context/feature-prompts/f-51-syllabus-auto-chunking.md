...
|-------|-------|
| **Feature ID** | F-51 |
| **Feature name** | Syllabus Auto-Chunking |
| **Release** | V2.0 |
| **Branch** | `feature/f-51-chunking` |
| **Prerequisites** | F-41 syllabus ingestion started. |
...
Post-MVP expansion requires Syllabus Auto-Chunking to scale ExamEdge beyond the Cameroon pilot.

## User value

Syllabus Auto-Chunking unlocks the roadmap milestone described in roadmap.md for V2.0.

## User stories

- As a platform stakeholder, I need syllabus auto-chunking so that ExamEdge can expand per roadmap.md.
- As a developer, I implement syllabus auto-chunking without breaking MVP invariants.

## Acceptance criteria

- [ ] roadmap.md acceptance criteria for F-51 met

## Prerequisites

Complete these units/features before starting F-51:
