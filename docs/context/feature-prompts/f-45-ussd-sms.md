# F-45: USSD / SMS (Africa's Talking)
...
|-------|-------|
| **Feature ID** | F-45 |
| **Feature name** | USSD / SMS (Africa's Talking) |
| **Release** | V2.0 |
| **Branch** | `feature/f-45-ussd-sms` |
...
Post-MVP expansion requires USSD / SMS (Africa's Talking) to scale ExamEdge beyond the Cameroon pilot.

## User value

USSD / SMS (Africa's Talking) unlocks the roadmap milestone described in roadmap.md for V2.0.

## User stories

- As a platform stakeholder, I need ussd / sms (africa's talking) so that ExamEdge can expand per roadmap.md.
- As a developer, I implement ussd / sms (africa's talking) without breaking MVP invariants.

## Acceptance criteria

- [ ] roadmap.md acceptance criteria for F-45 met

## Prerequisites

Complete these units/features before starting F-45:
