...
|-------|-------|
| **Feature ID** | F-41 |
| **Feature name** | WAEC / NECO (Nigeria, Ghana) |
| **Release** | V2.0 |
| **Branch** | `feature/f-41-waec-neco` |
...
Post-MVP expansion requires WAEC / NECO (Nigeria, Ghana) to scale ExamEdge beyond the Cameroon pilot.

## User value

WAEC / NECO (Nigeria, Ghana) unlocks the roadmap milestone described in roadmap.md for V2.0.

## User stories

- As a platform stakeholder, I need waec / neco (nigeria, ghana) so that ExamEdge can expand per roadmap.md.
- As a developer, I implement waec / neco (nigeria, ghana) without breaking MVP invariants.

## Acceptance criteria

- [ ] roadmap.md acceptance criteria for F-41 met

## Prerequisites

Complete these units/features before starting F-41:
