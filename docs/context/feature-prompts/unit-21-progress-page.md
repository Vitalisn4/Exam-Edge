...
|-------|-------|
| **Feature ID** | Unit 21 |
| **Feature name** | Progress Page + Session History |
| **Release** | V1.0 MVP |
| **Branch** | `feature/unit-21-progress-page` |
| **Prerequisites** | Unit 19 merged to main. |
...
This unit is required to deliver **Progress Page + Session History** as defined in `build-plan.md` Unit 21. Without it, the MVP pilot cannot proceed to the next build phase.
...
4. Create branch `feature/unit-21-progress-page`.
