...
| ----------------- | --------------------------------------- |
| **Feature ID**    | Unit 20                                 |
| **Feature name**  | Curriculum Explain UI                   |
| **Release**       | V1.0 MVP                                |
| **Branch**        | `feature/unit-20-curriculum-explain-ui` |
| **Prerequisites** | Units 14 and 16 merged to main.         |
...
This unit is required to deliver **Curriculum Explain UI** as defined in `build-plan.md` Unit 20. Without it, the MVP pilot cannot proceed to the next build phase.
...
Units 14 and 16 merged to main.
...
4. Create branch `feature/unit-20-curriculum-explain-ui`.
