# F-46: Whisper.cpp Oral Assessment
...
Post-MVP expansion requires Whisper.cpp Oral Assessment to scale ExamEdge beyond the Cameroon pilot.

## User value

Whisper.cpp Oral Assessment unlocks the roadmap milestone described in roadmap.md for V2.0.

## User stories

- As a platform stakeholder, I need whisper.cpp oral assessment so that ExamEdge can expand per roadmap.md.
- As a developer, I implement whisper.cpp oral assessment without breaking MVP invariants.

## Acceptance criteria

- [ ] roadmap.md acceptance criteria for F-46 met

## Prerequisites

Complete these units/features before starting F-46:
...
- Cloud Whisper API as primary — on-device first
